...
/**
 *  Chris Li, cl43, cs262, lab 04, Prof. Vanderlinden
 *  <p>
 *  This app has a menu in the top-right corner that takes you to an about page. User can use the Android return button to go back to the main page
 */
